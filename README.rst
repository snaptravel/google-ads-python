...
The only difference is the requirement for python 3.7 is lowered to 3.6 on branch 6.0.0_3.6 It should work with some caveats: https://github.com/googleads/google-ads-python/issues/319
